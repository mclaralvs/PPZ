...
for word in txtB:
    if len(word) == 7 and word[-1] in others:
        verb += 1
        if word[0] in others:
            verbFP += 1
...
print(f'Preposições: {prep}')
print(f'Verbos: {verb}')
print(f'Verbos em Primeira Pessoa: {verbFP}')
print(f'Texto em ordem Googlon: {lB}')
print(f'Números mágicos: {magic}')